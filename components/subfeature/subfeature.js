  ...
  return (
    <div className="flex-col py-[96px] px-[80px] bg-gray-50">
      ...
      <div className="md:flex gap-[70px] ">
        <div className="">
          <div className="flex w-[440px] h-[520px] ">
            <div className="relative w-[400px] h-[480px] md:h-[360px] md:w-[280px]">
              <Image src="/images/Pic.png" fill />
            </div>
            {/* <div className="bg-gray-200 w-[400px] h-[480px] absolute bottom-0"></div> */}
          </div>
        </div>
        <div className="max-w-[584px] max-h-[694px] flex flex-col gap-4">
          <div className="font-bold text-3xl mb-[24px]">
